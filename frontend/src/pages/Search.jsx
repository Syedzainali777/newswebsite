  ...
  return (
    <div className="flex flex-col md:flex-row bg-white dark:bg-gray-900 text-slate-700 dark:text-gray-300 min-h-screen">
        ...
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col gap-2">
            ...
            <Input
              ...
              id="searchTerm"
              type="text"
              className="border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-slate-700 dark:text-gray-300"
          ...
          <div className="flex flex-col gap-2">
            ...
            >
              <SelectTrigger className="w-full border border-slate-400 dark:border-gray-600 bg-white dark:bg-gray-700 text-slate-700 dark:text-gray-300">
      ...
      <div className="w-full">
        ...
        <Separator className="bg-slate-300 dark:bg-gray-700" />
        ...
        <div className="p-7 flex flex-wrap gap-4">
          ...
          {showMore && (
            <button
              ...
              className="text-slate-800 dark:text-gray-300 text-lg hover:underline p-7 w-full"
            >
              Show More
            </button>
          )}
